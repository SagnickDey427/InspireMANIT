...
export default function AboutSection() {
  return (
    <section className="bg-[#1a202c] py-20 overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            ...
            <Typography 
              ...
              sx={{ fontSize: '1.15rem' }}
            >
              "We voluntarily work to bejewel youths with wisdom and values to enable 
              them to lead a principle-centered life."
            </Typography>
            ...
            >
              ...
              overall growth and well-being of students while promoting 
